...
> `/smartthink <주제>` — Deep 분석 | `/smartthink light <주제>` — 빠른 분석 | `/smartthink search <주제>` — 검색 포함 분석
...
| 모듈 | 파일 | 핵심 역할 |
|------|------|----------|
| 핵심 엔진 | `@references/core-engines.md` | 12개 운영 사고 엔진 (제1원리, 비대칭 기회, 네트워크 효과, 시장 창조, 해자, 반직관 검증, 가치 포착, 타이밍, 복합 우위, 생태계) |
